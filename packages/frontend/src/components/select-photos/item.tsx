    ...
    return (
        ...
        >
            ...
            >
                ...
                <div className={`absolute inset-0 flex items-center justify-center transition-all ${isSelected ? "opacity-100" : "opacity-0"}`}>
            ...
            <div className="text-left">
                <p className={`text-sm transition-colors ${isSelected ? "text-primary" : "text-gray-500"}`}>{photo.name}</p>
            </div>
        </button>
    )
